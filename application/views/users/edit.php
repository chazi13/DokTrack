                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-8 col-sm-12">
                                <input type="text" name="nama" value="<?= $user->nama ?>" id="nama" class="form-control" placeholder="Masukan Nama Lengkap User" required>
                                <input type="hidden" name="user_id" value="<?= $this->enc->encode($user->user_id) ?>">
